...
// pushes 3/6 random colors to a colors array and then it returns it
...
const reset = () => {
    colors = generateColors(numberOfSquares); // set colors equal to that 3/6 colors array
    pickedColor = pickColorToGuess(); // picks one out of 3/6 colors
